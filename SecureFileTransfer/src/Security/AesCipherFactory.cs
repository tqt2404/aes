...
/// 
/// This factory creates Aes256Impl instances (fully custom AES from scratch) that work with CbcModeOperations
...
public class AesCipherFactory
{
    ...
    /// Uses Aes256Impl - complete custom AES-256 implementation from scratch.
    /// </summary>
    ...
    public static Aes256Impl CreateAes(byte[] key, AesKeySize keySize)
    {
        ...
        // Use Aes256Impl - fully custom AES implementation from scratch
        // Supports AES-128, AES-192, AES-256 automatically based on key length
        return new Aes256Impl(key);
    }
